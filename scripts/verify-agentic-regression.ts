...
const verifiers = [
  ...
  // (a harness chip click both selects and creates). Was previously written
  // but never wired into this suite — see this file's own header comment
  // for why an unwired harness is indistinguishable from no harness.
