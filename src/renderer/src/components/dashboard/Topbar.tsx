...
export function Topbar({ onToggleSidebar }: TopbarProps): React.JSX.Element {
  return (
    <header
      className="h-9 flex items-center px-3 relative bg-surface-base shrink-0"
    ...
    >
      ...
      <div className="flex items-center pl-20">
        <button
          ...
          className="p-1 text-text-secondary hover:text-text-primary hover:bg-surface-raised rounded transition-colors duration-100"
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <span className="text-base font-semibold tracking-tight text-text-primary select-none">
