...
const DotsPattern = ({ id }: PatternProps): React.JSX.Element => (
  <pattern id={id} x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
    <circle className="text-border dark:text-border" cx="2" cy="2" r="1" fill="currentColor" />
  </pattern>
)

const GridPattern = ({ id }: PatternProps): React.JSX.Element => (
  <pattern id={id} x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
    <path
...
const CrossHatchPattern = ({ id }: PatternProps): React.JSX.Element => (
  <pattern id={id} x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
    <path
...
const DiagonalLinesPattern = ({ id }: PatternProps): React.JSX.Element => (
  <pattern
    id={id}
    x="0"
    y="0"
...
const PlusPattern = ({ id }: PatternProps): React.JSX.Element => (
...
const FallingTrianglesPattern = ({ id }: PatternProps): React.JSX.Element => (
...
const FourPointedStarPattern = ({ id }: PatternProps): React.JSX.Element => (
  <pattern id={id} x="0" y="0" width="16" height="16" patternUnits="userSpaceOnUse">
    <polygon
      className="text-border dark:text-border"
      fillRule="evenodd"
...
const TinyCheckersPattern = ({ id }: PatternProps): React.JSX.Element => (
...
const OverlappingCirclesPattern = ({ id }: PatternProps): React.JSX.Element => (
...
const WiggleLinesPattern = ({ id }: PatternProps): React.JSX.Element => (
  <pattern
    id={id}
    x="0"
    y="0"
...
const BubblesPattern = ({ id }: PatternProps): React.JSX.Element => (
  <pattern
    id={id}
    x="0"
    y="0"
...
export function ChartBackground({ variant }: ChartBackgroundProps): React.JSX.Element {
